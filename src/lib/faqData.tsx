  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: (
          <div className="space-y-2">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              <li><strong>Flat Rate</strong> — interest is calculated on the original principal for every month.</li>
              <li><strong>Reducing Balance</strong> — interest is calculated only on the remaining outstanding balance each month.</li>
            </ul>
      ...
      },
      {
        ...
        answer: (
          <p>If your loan is marked as <strong>Defaulted</strong> by the administrator, your membership will be automatically <strong>suspended</strong>. Contact your cooperative administrator to resolve the situation.</p>
        ),
      },
    ],
  },
  {
    ...
    items: [
        ...
        answer: (
          <div className="space-y-2">
            ...
            <ol className="list-decimal list-inside text-sm space-y-1">
              ...
              <li>At the top you will see a <strong>Guarantor Requests</strong> section.</li>
              <li>Review the loan details — amount, term, and purpose.</li>
              <li>Click <strong>Confirm</strong> to agree, or <strong>Decline</strong> if you cannot.</li>
            </ol>
          </div>
        ),
      },
      ...
      },
      {
        ...
        answer: (
          <p>Yes. Click <strong>Decline</strong> on the request. The borrower will need to find a replacement co-maker. You cannot decline after you have already confirmed.</p>
        ),
      },
    ],
  },
...
export function AccordionItem({ question, answer }: FaqItem) {
